      ...
      {{ method_field('PUT') }}
        ...
        <div class="form-group">
          ...
          <select class="form-control" name="mahasiswa_id">
            <option selected>{{ $jadwal->mahasiswa_id }}</option>  
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="dosen_id">
              <option selected>{{ $jadwal->dosen_id }}</option>  
              @foreach($dosen as $d)
              <option>{{ $d->id }}</option>
              @endforeach
            </select>
        ...
        <div class="form-group">
            <label>judul</label>
            <input type="text" class="form-control" name="judul" placeholder="masukan judul" value="{{ $jadwal->judul }}">
        </div>
        <div class="form-group">
          <label>deskripsi</label>
          <textarea class="form-control" name="deskripsi" rows="3">{{ $jadwal->deskripsi }}</textarea>
        </div>
